<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="intellego.index" %>
		...
		<div id="todo" align="center">
			...
			<div id="wrap" align="center">
				...
				<div id="header-nav-bottom">
					<ul>
						<li>
							<a href="index.aspx" class="selected">Home</a>
						</li>
						<li>
				...
				<div id="middle-column" align="left">
					...
					<div style="position: relative; height: 464px; text-align: left">
						...
						<asp:Panel id="Panel1" runat="server" Height="266px" Width="430px" style="z-index: 101; left: 0px; position: absolute; top: 8px; text-align:justify;">
							...
							<p>
							    ...
							    <asp:repeater id="rptNews" runat="server">
								    ...
								    <ItemTemplate>
									    <font size="1">
									        <b>
											    <%#DataBinder.Eval(Container.DataItem, "snewstitle")%>
										    </b>
									    </font>
									    <br />
									    <font size="1">
										    <%#DataBinder.Eval(Container.DataItem, "snewscontent")%>
									    </font>
									    <br />
									    <br />
									    <br />
