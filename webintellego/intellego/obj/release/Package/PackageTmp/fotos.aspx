<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="fotos.aspx.vb" Inherits="intellego.fotos" %>
			...
			<div id="wrap" align="center">
				...
				<div id="header-nav-bottom">
					<ul>
						...
						<li>
							<a class="selected" href="fotos.aspx">Galer&iacute;a de Fotos </a>
						</li>
						<li>
				...
				<div id="middle-column" align="left">
					...
					<div style="position: relative; height: 464px; text-align: center">
					    
					    <br />
						<asp:Panel id="Panel1" runat="server" Height="266px" Width="368px" style="z-index: 101; left: 0px; position: absolute; top: 8px; text-align: center">
							<p>&nbsp;</p>
							<a href="images/photo02.jpg" target="_blank"><img height="70" src="images/photo02.jpg" alt="" border="0" /></a>
							<a href="images/photo15.jpg" target="_blank"><img height="70" src="images/photo15.jpg" alt="" border="0" /></a>
							<br />
							<a href="images/photo03.jpg" target="_blank"><img height="70" src="images/photo03.jpg" alt="" border="0" /></a>
							<a href="images/photo04.jpg" target="_blank"><img height="70" src="images/photo04.jpg" alt="" border="0" /></a>
						</asp:Panel>
