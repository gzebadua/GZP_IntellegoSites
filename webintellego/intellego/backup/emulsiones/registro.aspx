<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="registro.aspx.vb" Inherits="intellego.registro" %>
...
<head id="Head1" runat="server">
	...
	<title>Registro de Participantes para la Conferencia "Emulsiones: Aplicaciones y Retos en la Industria Alimentaria"</title>
...
<body onkeydown="if(event.keyCode == 13){document.getElementById('btnSave').click();}">
		...
		<form id="form1" method="post" runat="server">
			...
			<div style="text-align:center; width:100%;">
			    ...
			    <br />
			    <asp:Label id="lblPageTitle" runat="server" Font-Names="Arial" Font-Size="Large">Registro en Línea</asp:Label>
			    <br />
			    <br />
