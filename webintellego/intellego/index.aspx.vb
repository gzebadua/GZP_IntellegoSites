Public Partial Class index
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            rptNews.DataSource = getSQLQueryAsDataset("SELECT n.snewstitle, n.snewscontent, STR_TO_DATE(concat(n.idate, n.stime),'%Y%m%d%H:%i:%s') FROM news n ORDER BY idate DESC")
            rptNews.DataBind()
